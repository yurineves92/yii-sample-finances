 ...
 */
class m200716_021123_create_bills_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->batchInsert('{{%bills}}', ['category_id', 'type', 'date', 'description', 'amount', 'created_at'], [
            ...
            [1, 2, '2020-01-08', 'Monitor LED 23', -679.00, new Expression('NOW()')],
            ...
            // Moradia
            [3, 2, '2020-01-12', 'Condominio', -300.00, new Expression('NOW()')],
